...
<body>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="nav-link js-scroll-trigger" href="{{ url('/product') }}">Data Product</a></li>
              <li><a class="nav-link js-scroll-trigger" href="{{ url('/customer') }}">Data Customer</a></li>
              <li><a class="nav-link js-scroll-trigger" href="{{ url('kota') }}">Data Kota</a></li>
            </ul>
          </li>
          <li>
  ...
  <!-- charts scripts -->
  <script src="assets/jquery-knob/{{asset('assets/js/jquery.knob.js') }}"></script>
